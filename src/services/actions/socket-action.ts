import { IWSActions, IWSOrdersPayload } from '../../utils/types';
...
export type TWSActions = IWSConnectionStartAction | IWSConnectionSuccessAction | IWSConnectionErrorAction | IWSConnectionClosedAction | IWSGetOrdersAction;

export type TWSAuthActions = IWSAuthConnectionStartAction | IWSAuthConnectionSuccessAction | IWSAuthConnectionErrorAction | IWSAuthConnectionClosedAction | IWSGetAuthOrdersAction;
